...
const CetaProgram = () => {
  return (
    <div className="flex flex-col gap-40 mt-16">
      <div className="flex flex-col gap-24 w-[80%] m-auto med:w-full">
        <div className="flex flex-col gap-9 w-[50%] m-auto med:w-full">
          <span
          ...
          <span
            className={`${outfit.className} font-light text-xl text-[#012376] text-center sem:w-[90%] sem:m-auto`}
          >
          ...
          <div className="flex gap-8 justify-center">
            <Link href="https://edubuk.co.in/ " target="_blank">
              <button
                className={`rounded-[20px] font-normal text-xl text-center text-[#ffffff] bg-gradient-to-r from-[#012376] to-[#009EFF] ${outfit.className} flex py-2 px-6`}
              >
                Explore More
              </button>
            </Link>
        ...
        <div className="flex flex-col gap-5  m-auto med:w-full sem:w-[90%]">
          <div className="flex gap-7 sem:flex-col sem:items-center">
            <div className="rounded-[20px] w-[325px] h-[200px] justify-center border border-solid border-[#AECFFF47] bg-[#AECFFF47] py-7 px-9 flex items-center sem:p-4">
              <span
        ...
        <div className="flex flex-col items-center gap-8">
          <span
            className={`${outfit.className} font-medium text-2xl text-[#012376] text-center w-[55%]`}
          >
          ...
          <Image alt="frame" src="/images/frame.png" width={954} height={121} />
        </div>
      </div>
      <div className="rounded-3xl border border-solid border-[#9DB8FF1F] bg-[#9DB8FF1F] py-16 px-5 flex flex-col items-center gap-9 shadow-[0px_24px_32px_0px_#00000005] w-[90%] m-auto">
        <span
        ...
        ></iframe>
        <span
          className={`${outfit.className} font-light text-xl text-[#012376] text-center w-[70%] sem:w-full`}
        >
        ...
        <div className="flex gap-6 flex-wrap justify-center">
          <Image alt="pic" src="/images/4.jpeg" width={400} height={400} />
          <Image alt="pic" src="/images/34.jpeg" width={400} height={400} />
          <Image alt="pic" src="/images/38.jpg" width={400} height={400} />
          <Image alt="pic" src="/images/39.jpg" width={400} height={400} />
          <Image alt="pic" src="/images/5.jpeg" width={400} height={400} />
          <Image alt="pic" src="/images/45.jpeg" width={400} height={400} />
        </div>
      </div>
    </div>
  );
